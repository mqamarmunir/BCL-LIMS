<%@ Page Title="" Language="C#" MasterPageFile="~/CahierMasterPage.master" AutoEventWireup="true" CodeFile="wfrmInvestigation Rate.aspx.cs" Inherits="transaction_wfrmInvestigation_Rate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <div>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <div class="tboxhead" style="text-align:center; width:100%; padding-top:10px;">Investigation Calculator</div>
                ...
                <asp:UpdatePanel ID="up_war" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnl_ward" runat="server" Width="100%" BorderStyle="Solid" BorderWidth="2px">
                            <table id="tb_ward" border="0" cellpadding="1" cellspacing="1" class="label" 
    ...
    <table width="100%">
        <tr>
            <td valign="top" width="30%" style="display: none;">
                                ...
                                <tbody>
                                    <tr style="background-color:#A6c9e2;">
                                        ...
                                        <td>
                                            ...
                                            <asp:Image Width="16px" Height="16px" ImageUrl="../images/search.png" runat="server" ID="Images_Search" />
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div style="overflow-y: auto; vertical-align: top; width: 42%; position: absolute;
                                                height: 300px">
                                                <asp:GridView ID="gvTestList" Font-Size="10px" runat="server" Width="99%" CssClass="listing" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<asp:ButtonField DataTextField="testname" HeaderText="Test" CommandName="testselect">
...
<br />                     <asp:LinkButton ID="lbtnAdd" style="float:right; margin-right:20px;"  runat="server" OnClick="lbtnAdd_Click"><asp:Image ImageUrl="headerfooter/select.jpg" ID="selectionimage" runat="server" /></asp:LinkButton>
                        ...
                        <asp:Panel ID="pnl_testPick" runat="server" BorderStyle="Solid" BorderColor="Tan"
                            ...
                            <table id="tb_pick" class="label" cellspacing="1" cellpadding="1" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="overflow-y: auto; vertical-align: top; width: 31%; position: absolute;
                                                height: 300px">
                                                <asp:GridView Font-Size="10px" ID="gvTestPick" runat="server" Width="99%" CssClass="datagrid" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField Visible="false" DataField="deliveredon" HeaderText="Delivered On">
                                                            <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Left" Width="30%"></ItemStyle>
                                                        </asp:BoundField>
                                                        <asp:CommandField DeleteText="&lt;img src='headerfooter/cancel.png' border='0' /&gt;"
...
&nbsp;
                                        ...
                                        <asp:ImageButton runat="server" ID="Img_CalculateDiscount" 
                                        ImageUrl="../images/money1.png" onclick="Img_CalculateDiscount_Click" />
                                </td>
                            </tr>
                            <tr style="visibility:hidden; display:none;">
                            <td><asp:Label ID="lblCash" runat="server"></asp:Label></td>
                            <td><asp:TextBox ID="txtCash" runat="server" Width="8%" CssClass="mandatoryField" BackColor="#FFE0C0"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td>Total Charges:</td>
                                <td>
                                <asp:Label ID="lblcharges" runat="server" Font-Bold="True" ForeColor="Indigo"></asp:Label>
                        <asp:CheckBox ID="chkOnCASH" runat="server" Visible="false" Text="On Cash" OnCheckedChanged="chkOnCASH_CheckedChanged"
