<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyTestDefault.aspx.cs" Inherits="transaction_MyTestDefault" %>
...
<body>
   ...
   <div>
    ...
    <table style="color:#06C;display:none;">
    <tr>
        <td>
                            ...
                            <table id="tb_testlist" class="label" cellspacing="1" cellpadding="1" width="100%"
                                ...
                                <tbody>
                                    <tr style="background-color:#A6c9e2;">
                                        <td>
                                            <img alt="" src="../img/testarr (2).png" align="middle" unselectable="on" />
                                        </td>
                                        <td>
                                            Test List &nbsp;&nbsp;
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div style="overflow-y: auto; vertical-align: top; width: 55%; position: absolute;
                                                height: 300px">
                        ...
                        <asp:Panel ID="pnl_testPick" runat="server" BorderStyle="Solid" BorderColor="Tan"
                            ...
                            <table id="tb_pick" class="label" cellspacing="1" cellpadding="1" width="100%" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="overflow-y: auto; vertical-align: top; width: 40%; position: absolute;
                                                height: 300px">
