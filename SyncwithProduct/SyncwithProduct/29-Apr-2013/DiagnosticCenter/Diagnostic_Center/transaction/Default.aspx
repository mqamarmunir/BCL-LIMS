<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="transaction_Default" %>
          ...
          <asp:GridView Width="100%" Font-Size="12px" style="font-family:Tahoma; color:Black;" 
            ...
            <Columns>
              ...
              <HeaderStyle Wrap="True" />
                ...
                <wc:ReportGridView GridLines="None" Font-Size="11px" style="top:165px; position:relative;" runat="server"   ID="Gv_GroupTest" 
             AutoGenerateColumns="false" PrintPageSize="3" AllowPrintPaging="true" 
                        ...
                        <tr>
                            <td>
                                   <table width="100%" border="0">
                                                ...
                                                <tr><td colspan="4" style="width:45%"></td>
                                                    <td align="center" style="background-color:#EEEEEE; font-weight:bold;">Result(s)</td>
                                                </tr>
                                                <tr>
                                                <td colspan="5" style="" >
...
<%--<table class="style2" width="98.5%" style="border-radius:8px; bottom:0; position:fixed; font-size: 8px;">
                <tr style="border-bottom:1px solid #DDDDDD;">
