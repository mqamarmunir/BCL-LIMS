...
public partial class transaction_RptDueBalance : System.Web.UI.Page
{
    ...
    public void CashGridBind()
    {
        ...
        {
            double balance = Convert.ToDouble(dv[i]["bal"]);
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            try
            {
                ...
                //{
                    ...
                    hyperLink_Balance.NavigateUrl = "wfrmCash.aspx?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&pname=" + DataBinder.Eval(e.Row.DataItem, "name") + "&totalAmt=" + DataBinder.Eval(e.Row.DataItem, "totalamount") + "&amount=" + DataBinder.Eval(e.Row.DataItem, "paidamount");
                    hyperLink_Balance.Target = "wfrmCash.aspx?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&pname=" + DataBinder.Eval(e.Row.DataItem, "name") + "&totalAmt=" + DataBinder.Eval(e.Row.DataItem, "totalamount") + "&amount=" + DataBinder.Eval(e.Row.DataItem, "paidamount");
                //}
