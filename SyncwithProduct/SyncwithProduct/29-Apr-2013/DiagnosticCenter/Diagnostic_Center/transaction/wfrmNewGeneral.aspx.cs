...
public partial class transaction_wfrmNewGeneral : System.Web.UI.Page
{
    ...
    protected void gvCash_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                hyperLink_Payment.NavigateUrl = dv_cashreport[0]["Reportformat_path"].ToString().Trim() + "?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&referenceno=" + "&watermark=watermark";
                hyperLink_Payment.Target = dv_cashreport[0]["Reportformat_path"].ToString().Trim() + "?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&referenceno=" + "&watermark=watermark";

            }
            else
            {
                hyperLink_Payment.NavigateUrl = "wfrmCashReport.aspx?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&referenceno=" + "&watermark=watermark";
                hyperLink_Payment.Target = "wfrmCashReport.aspx?labid=" + DataBinder.Eval(e.Row.DataItem, "labid") + "&prno=" + DataBinder.Eval(e.Row.DataItem, "prno") + "&referenceno=" + "&watermark=watermark";
            }
