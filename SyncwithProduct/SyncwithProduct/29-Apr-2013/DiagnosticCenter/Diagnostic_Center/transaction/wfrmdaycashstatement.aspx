<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfrmdaycashstatement.aspx.cs" Inherits="transaction_wfrmdaycashstatement" %>
...
<fieldset  style="border-radius:10px;">
        <legend style="font-size:9px;">Credit Panel Receipt</legend>
        <asp:GridView GridLines="None" Font-Size="9px" 
            style="font-family:Tahoma;"  ID="GVCreditPanel" runat="server" 
            AutoGenerateColumns="False" Width="100%" CellPadding="2" ForeColor="#333333">
            <RowStyle BackColor="#D1EED6" />
        <Columns>
            <asp:TemplateField HeaderText="Sr #">
        ...
        <table width="100%">
            <tr>
                <td align="right">
                         <asp:Label ID="Label4" Font-Size="11px" Font-Bold="true" Text="Total On Account ==" runat="server" ></asp:Label>
                         <asp:Label ID="lblcptotal" Font-Bold="true" Font-Size="11px" runat="server" ></asp:Label>
                         &nbsp;&nbsp;
                         <asp:Label ID="Label9" Font-Size="11px" Font-Bold="true" Visible="false" 
                             Text="Debit Card Receivings ==" runat="server" ></asp:Label>
                         <asp:Label ID="Label10" Font-Bold="true" Visible="false" Font-Size="11px" 
                             runat="server" ></asp:Label>
                             &nbsp;&nbsp;
                         <asp:Label ID="Label11" Font-Size="11px" Font-Bold="true" Visible="false"
                             Text="Credit Card Receivings ==" runat="server" ></asp:Label>
                         <asp:Label ID="Label12" Font-Bold="true" Font-Size="11px"  Visible="false"
                             runat="server" ></asp:Label>
