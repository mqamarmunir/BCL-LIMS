<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptDueBalance.aspx.cs" Inherits="transaction_RptDueBalance" %>
...
<body>
    ...
    <div>
           ...
           <td align="center" style="width:70%;"><h2>OutStanding Balance</h2>
           ...
           <asp:Label ID="lblError" runat="server" Text=""></asp:Label>
             ...
             <fieldset style="border-radius:12px;">
               ...
               <asp:GridView ID="Gv_DueBalance" runat="server" AutoGenerateColumns="False" 
                   Font-Size="11px" HorizontalAlign="Left" Width="100%" CellPadding="2" 
                   ...
                   <Columns>
                       ...
                       <asp:BoundField DataField="enteredon" HeaderText="Date" 
                           ...
                           <asp:TemplateField HeaderText="Age">
                            <ItemTemplate>
                                <asp:Label ID="Lb_AgeDays" runat="server" Text='<%# Eval("Age") %>'></asp:Label>
                                days
                            </ItemTemplate>
