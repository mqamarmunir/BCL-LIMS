<%@ Page Title="" Language="C#" MasterPageFile="~/CahierMasterPage.master" AutoEventWireup="true"
    CodeFile="wfrmNewPatientReegistration.aspx.cs" Inherits="transaction_wfrmNewPatientReegistration" %>
...
//-->
 ...
 <div class="tboxhead" style="text-align:center; width:100%; padding-top:10px;">Patient Registration &amp; Investigation Booking</div>
    <asp:UpdatePanel ID="updtee" runat="server">
    <ContentTemplate>
        ...
        <tr>
            <td colspan="8">
             ...
             <asp:UpdatePanel ID = "up_pateintInfo" runat="server">
                <ContentTemplate>
<asp:Panel id="pnlPatient" runat="server" Width="99%" GroupingText="Patient Info">
<TABLE id="tb_patient" class="label" cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY><TR><TD>PR No:</TD><TD>
        <asp:Panel ID="pnlsearchbypr" runat="server" DefaultButton="imgPRno">
        <asp:TextBox id="txtPRnO" runat="server" ToolTip="Please enter PR #" Width="80%" CssClass="txtareaStyle"></asp:TextBox> 
        <asp:ImageButton id="imgPRno" onclick="imgPRno_Click" runat="server" ImageUrl="~/img/searchcase.png"></asp:ImageButton>
        </asp:Panel>
        </TD><TD>Cell No.</TD>
        <td>
        <asp:Panel ID="pnlcellnosearch" runat="server" DefaultButton="imgcellnosearch">
        <asp:TextBox id="txtCellNo" tabIndex=7 runat="server" ToolTip="Please enter patient cell number" Width="75%" CssClass="txtareaStyle" MaxLength="20"></asp:TextBox>
            <asp:ImageButton ID="imgcellnosearch" runat="server" ImageUrl="~/img/searchcase.png" 
                onclick="imgcellnosearch_Click" />
           <cc1:TextBoxWatermarkExtender id="wt_cel" watermarkText="3331234567" runat="Server" 
                   TargetControlID="txtCellNo" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender>
                   </asp:Panel> 
</td>
        ...
        <asp:RadioButton id="rdbPnl_Cash" runat="server" Font-Bold="True" ForeColor="Teal" __designer:wfdid="w33" Text="Panel-Cash" Visible="true" OnCheckedChanged="rdbPnl_Cash_CheckedChanged" AutoPostBack="True" GroupName="CHK"></asp:RadioButton>
        </ContentTemplate>
        </asp:UpdatePanel>
...
<asp:ListItem>M/O</asp:ListItem>
 ...
 <asp:TextBox ID="txtReferenceNo" runat="server" __designer:wfdid="w1" 
            CssClass="txtareaStyle" MaxLength="25" Width="25%"></asp:TextBox>
 </td>
 </tr>
 <TR><TD colSpan=8>
 ...
 <TD> <asp:UpdatePanel id="UpdatePanel1" runat="server">
            <ContentTemplate>
 <asp:DropDownList id="ddlPanel" runat="server" ToolTip="Please select panel company" 
                    Width="100%" CssClass="dropdownMan" 
                    OnSelectedIndexChanged="ddlPanel_SelectedIndexChanged">
                                                </asp:DropDownList>

                                                <cc1:ListSearchExtender ID="lse1" runat="server" TargetControlID="ddlPanel"></cc1:ListSearchExtender>
                                                </ContentTemplate>
                                                </asp:UpdatePanel>
                                                </TD>
        ...
        </TD><TD width="20%"></TD><TD width="10%"></TD><TD width="16%"></TD></TR></TBODY></TABLE></asp:Panel> </TD></TR><TR><TD>Salutation:</TD>
        <TD><asp:DropDownList id="ddlTitle" Enabled="true" tabIndex=1 runat="server" ToolTip="Please select Salutation" Width="40%" CssClass="dropdown" onchange="changeParameter();"><asp:ListItem Value="-1">Select</asp:ListItem>
...
<asp:CheckBox id="chkTitleENB" runat="server" __designer:wfdid="w1" Text="Skip Title" OnCheckedChanged="chkTitleENB_CheckedChanged" AutoPostBack="false" Checked="false"></asp:CheckBox>
</TD><TD align="left">Name:&nbsp; </TD>
...
<cc1:CalendarExtender ID="calextdob" runat="server" TargetControlID="txtDOB" Format="dd/MM/yyyy"></cc1:CalendarExtender>
 </TD>
<TD align="left">Age:&nbsp; </TD>
<TD>
<asp:TextBox id="txtAge" tabIndex=6 runat="server" ToolTip="Enter age in years " Width="30%" CssClass="mandatoryField" MaxLength="3"></asp:TextBox>
 <asp:DropDownList id="ddlAge_Opt" runat="server" Width="60%" CssClass="dropdown">
...
<TD><asp:DropDownList id="ddlMarital" tabIndex=8 runat="server" ToolTip="Please select Patient Marital Status" Width="80%" CssClass="dropdownMan">
                                    <asp:ListItem Value="-1">Select</asp:ListItem>
...
<tr>
<TD>Remarks: &nbsp; 
<asp:LinkButton id="lbtnAdd_Rmk" onclick="lbtnAdd_Rmk_Click" runat="server" __designer:wfdid="w1">Add</asp:LinkButton>
</TD>
<TD>
<asp:TextBox id="txtRemark" runat="server" Width="78%" CssClass="txtareaStyle" __designer:wfdid="w2" TextMode="MultiLine"></asp:TextBox>
<asp:ImageButton id="imgOpn_Rmk" onclick="imgOpn_Rmk_Click" runat="server" ImageUrl="~/images/expandw.jpg" __designer:wfdid="w3"></asp:ImageButton>
</TD></TR><TR><TD></TD><TD></TD>
<TD align=right></TD><TD colSpan=3></TD><TD class="style2"></TD>
<TD>
<asp:ListBox id="lbTemplate" runat="server" Visible="False" Width="97%" __designer:wfdid="w4" AutoPostBack="True" OnSelectedIndexChanged="lbTemplate_SelectedIndexChanged">
</asp:ListBox>
</TD>
</TR>
<TR>
...
</asp:GridView> </TD><TD class="style2"></TD><TD></TD></TR>
<TR><TD colSpan=4>
<cc1:FilteredTextBoxExtender id="flt_name" runat="server" TargetControlID="txtName" ValidChars="  /" FilterType="Custom,UppercaseLetters,Numbers,LowercaseLetters" ></cc1:FilteredTextBoxExtender>
<cc1:FilteredTextBoxExtender id="flt_Age" runat="server" TargetControlID="txtAge" FilterType="Numbers"></cc1:FilteredTextBoxExtender> 
...
<cc1:MaskedEditExtender id="msk_DOB" runat="Server" TargetControlID="txtDOB" Mask="99/99/9999" ClearMaskOnLostFocus="false" AutoComplete="false"></cc1:MaskedEditExtender> 
<cc1:TextBoxWatermarkExtender id="wt_ser" watermarkText="ABC-091202" runat="Server" TargetControlID="txtSErviceno" WatermarkCssClass="waterlabel">
</cc1:TextBoxWatermarkExtender> 
</TD><TD colSpan=4>
<cc1:TextBoxWatermarkExtender id="wt_pr" watermarkText="001-09-90900786" runat="Server" TargetControlID="txtPRnO" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_Name" watermarkText="Please enter patient name over here" runat="Server" TargetControlID="txtName" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_DOC" watermarkText="01/01/1900" runat="Server" TargetControlID="txtDOB" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_age" watermarkText="26" runat="Server" TargetControlID="txtAge" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
</TD></TR>
        ...
        <tr>
           ...
           <TR><TD>Phone No:</TD>
           <TD>
           <asp:TextBox id="txtHPHone" tabIndex=9 runat="server" ToolTip="Please enter patient phone number" Width="97%" CssClass="txtareaStyle" MaxLength="20"></asp:TextBox>
           </TD>
           <TD align="left">Fax:&nbsp; </TD>
           <TD>
           <asp:TextBox id="txtFax" tabIndex=10 runat="server" ToolTip="Please enter patient fax number" Width="95%" CssClass="txtareaStyle" MaxLength="20"></asp:TextBox>
           </TD>
          <TD align="right">&nbsp; </TD>
<TD>
    &nbsp;</TD>
        ...
        <TR>
        <TD>Email:</TD>
        <TD><asp:TextBox id="txtEmail" tabIndex=12 runat="server" ToolTip="Please enter patient email address" Width="95%" CssClass="txtareaStyle"></asp:TextBox>
        </TD>
         <TD align="right">CNIC:&nbsp; </TD>
           <TD>
           <asp:TextBox id="txtCNIC" tabIndex=11 runat="server" ToolTip="Please enter patient CNIC" CssClass="txtareaStyle"></asp:TextBox></TD>
           
        <TD align="right">Address:</TD>
        <TD colSpan=3>
        <asp:TextBox id="txtAddress" tabIndex=13 runat="server" ToolTip="Please enter patient address" Width="85%" CssClass="txtareaStyle" Height="39px" TextMode="MultiLine"></asp:TextBox>
        </TD>
        
           </TR>
<cc1:TextBoxWatermarkExtender id="wt_Hphone" watermarkText="21362616" runat="Server" TargetControlID="txtHPHone" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_fax" watermarkText="2136666166" runat="Server" TargetControlID="txtFax" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_CNIC" watermarkText="37405-0011101-1" runat="Server" TargetControlID="txtCNIC" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_email" watermarkText="info@treesvalley.com" runat="Server" TargetControlID="txtEmail" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:TextBoxWatermarkExtender id="wt_address" watermarkText="House # 123,st#4........" runat="Server" TargetControlID="txtAddress" WatermarkCssClass="waterlabel"></cc1:TextBoxWatermarkExtender> 
<cc1:MaskedEditExtender id="msk_nic" runat="Server" TargetControlID="txtCNIC" Mask="99999-9999999-9" ClearMaskOnLostFocus="false" AutoComplete="false"></cc1:MaskedEditExtender> 
...
></cc1:ComboBox>     </div>       </td>
    ...
    <asp:Panel id="pnlGen" runat="server" Width="99%" GroupingText="Referral Info" Height="50px" __designer:errorcontrol="'Enter here if not available in previous list' could not be set on property 'WatermarkText'.">
    <TABLE id="tb_gen" class="label" cellSpacing=1 cellPadding=1 width="100%" border=0>
        <TBODY><TR><TD>
    Referring Doctor:</TD><TD class="mandatoryField"><asp:DropDownList id="ddlDoctor" runat="server" ToolTip="Select referring doctor from list" Width="100%" CssClass="dropdown">
                                ...
                                <tr>
                                <td width="50%">
                                 <asp:TextBox id="txtReferredBy" runat="server" ToolTip="Enter here if not available in previous list " Width="100%" CssClass="mandatoryField" MaxLength="50"></asp:TextBox>
                                </td>
                                <td width="50%">
                                 <asp:TextBox ID="txtPathCliqueiD" runat="server" CssClass="field" MaxLength="15" Width="100%"></asp:TextBox>
                                </td>
                                ...
                                </asp:DropDownList></TD><TD align=right>Authorization No:</TD><TD><asp:TextBox id="txtAuthorize" runat="server" ToolTip="Please enter authorization number" Width="96%" CssClass="mandatoryField" MaxLength="30"></asp:TextBox> </TD></TR><TR><TD></TD>
                                <TD>
                                <cc1:TextBoxWatermarkExtender id="wt_ref" watermarkText="Enter here if not available in previous list" runat="Server" WatermarkCssClass="waterlabel" TargetControlID="txtReferredBy">
                                </cc1:TextBoxWatermarkExtender> 
                                <cc1:TextBoxWatermarkExtender id="wt_auth" watermarkText="AT-09-099987" runat="Server" WatermarkCssClass="waterlabel" TargetControlID="txtAuthorize">
                                </cc1:TextBoxWatermarkExtender>
                                 <cc1:TextBoxWatermarkExtender id="wm_clique" watermarkText="CliqueID" runat="Server" WatermarkCssClass="waterlabel" TargetControlID="txtPathCliqueiD">
                                </cc1:TextBoxWatermarkExtender>
                                 </TD>
                                 <TD>
                                 </TD>
                                 <TD align=right></TD><TD></TD><TD align=right></TD><TD></TD></TR><TR><TD width="11%"></TD><TD width="18%"></TD><TD width="20%"></TD><TD width="10%"></TD><TD width="14%"></TD><TD width="11%"></TD><TD width="16%"></TD></TR></TBODY></TABLE>
                                </asp:Panel> 
</ContentTemplate>
                <triggers>
...
<asp:AsyncPostBackTrigger ControlID="rdbPanel" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>
        ...
        <tr>
            <td colspan="8">
                <asp:GridView ID="gvPatient" runat="server" CssClass="listing" AutoGenerateColumns="False" Width="99%" DataKeyNames="prid,title,name,cnic,address,panelid,serviceno,fax,relation,panelpatient,f_parent,email,dob,authorizeno,cashpanel" OnRowCommand="gvPatient_RowCommand">
