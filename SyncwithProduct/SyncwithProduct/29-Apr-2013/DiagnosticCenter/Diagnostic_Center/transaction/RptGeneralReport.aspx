  ...
  <asp:Label ID="Lb_Extension" Font-Size="9px" runat="server" Text=""></asp:Label>
   ...
   <asp:Label ID="Lb_dateAll" Visible="false" runat="server" Text=""></asp:Label>
     ...
     <fieldset style="border-radius:10px;">
      ...
      <%--<fieldset style="border-radius:10px; min-height:550px;">  --%>  
        <asp:GridView PageSize="1" DataKeyNames="bookingdid,testid,prid,automatedtext"   AllowPaging="false"  ID="Gv_GroupTest"  GridLines="None" Font-Size="12px" 
            ...
            <asp:TemplateField>
                <ItemTemplate>
                        ...
                        <tr>
                        <td>
                              <%--<asp:GridView ID="Gv_SeeBelow" runat="server" AutoGenerateColumns="False" 
                                ...
                                <asp:Label Font-Size="8px"  ID="Label1" runat="server" Text=""></asp:Label>
                        </td>
                        </tr>
                        <tr>
                                                <td>
            ...
            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            <PagerSettings Visible="false" Mode="NextPrevious" 
                NextPageImageUrl="~/img/notification/Next.png" NextPageText=" Next Page Print" 
                PreviousPageImageUrl="~/img/notification/Previous.png" 
                PreviousPageText="Previous Page Print" />
       ...
       <asp:Label Visible="false" ID="Lb_PrintCount" style="float:right; font-size:10px;" runat="server" Font-Bold="true" Text=""></asp:Label>
      <%--</fieldset>--%>
      ...
      <asp:Label Font-Bold="true" style="float:left;" Font-Size="6px" ID="Label1" runat="server" Text="Electronically verified report. Signatures not required."></asp:Label>
      ...
      <table class="style2" width="100%" style="border-radius:8px;border:1px solid #CCCCCC;font-size: 6px;">
            <tr>
                ...
                <td width="12.5%" valign="top">
                 ...
                 <td width="12.5%" valign="top">
                    <asp:Label ID="Label33" runat="server" Font-Bold="true" Text="LT COL (R) Dr. Nasir Rafi"></asp:Label>
                </td>
                <td width="12%" valign="top">
