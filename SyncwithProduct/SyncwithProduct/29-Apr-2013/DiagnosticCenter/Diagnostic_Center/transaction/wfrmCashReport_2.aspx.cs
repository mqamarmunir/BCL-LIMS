...
public partial class transaction_wfrmCashReport : System.Web.UI.Page
{
    ...
    clsBLPreferenceSettings obj_printpreferences = new clsBLPreferenceSettings();
    string cellno = "";
    ...
    {
        DataView dv_prefernces = obj_printpreferences.GetAll(1);
        Gv_PatientReceipt.PrintPageSize = Convert.ToInt16(dv_prefernces[0]["Recordsperpage_cashrec"].ToString().Trim());
        BranchName();
    ...
    public void patientPrimaryInformation()
    {
       ...
       // patient.LabID = Session["labid"].ToString();
        ...
        string payment_mode = dv[0]["paymentmode"].ToString().Trim() ;
    ...
    {
        //        DataView dv_printpref = obj_printpreferences.GetAll(1);
        ...
        string printgeneralcomments = dv[0]["PrintTestComents"].ToString().Trim();
        if (printgeneralcomments== "Y")
        {
