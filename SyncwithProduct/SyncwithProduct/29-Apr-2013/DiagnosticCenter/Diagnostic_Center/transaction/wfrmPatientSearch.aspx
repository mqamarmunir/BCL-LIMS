...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        function chkallchanged(cb) {
            if (cb.checked == true) {
                //alert(cb.checked);
                document.getElementById('lnkspecmen').checked = true;
                document.getElementById('lnkwlist').checked = true;
                document.getElementById('lnkREntry').checked = true;
                document.getElementById('lnkRVerif').checked = true;
                document.getElementById('lnkReady').checked = true;
                document.getElementById('lnkRefund').checked = true;
                document.getElementById('lnkArchived').checked = true;
                //unpaid.checked = true;
            }
            else {
                document.getElementById('lnkspecmen').checked = false;
                document.getElementById('lnkwlist').checked = false;
                document.getElementById('lnkREntry').checked = false;
                document.getElementById('lnkRVerif').checked = false;
                document.getElementById('lnkReady').checked = false;
                document.getElementById('lnkRefund').checked = false;
                document.getElementById('lnkArchived').checked = false;
            }
            //alert(cb);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table><tr> 
    <td>
    <asp:RadioButton ID="rdinoutboth" runat="server" Text="All" 
                    GroupName="IndoorOutdoor" ForeColor="Brown" Checked="true" />
    </td>
     <td >
              <asp:RadioButton ID="rdOutDoor" GroupName="IndoorOutdoor" runat="server" Text="Outdoor" 
                     ForeColor="Brown" Checked="false" />
            </td>
            <td>
                <asp:RadioButton ID="rdIndoor" ForeColor="Brown" runat="server" Text="Indoor" 
                    GroupName="IndoorOutdoor" />
            </td></tr></table>
   </div>
...
<div style="clear:both;"></div>
    ...
    <asp:Panel ID="pnlsearchbasic" runat="server" DefaultButton="ImageButton1">
    ...
    <fieldset id="Main" width="99%" style="display: inline; font-size: 9px;">
    ...
    <asp:Panel id="pnl_Test" runat="Server" style="font-size:10px;" Width="99%" GroupingText="Test Info:">
        <table id="tb_test" style="font-size:10px;" class="label" cellspacing="1" cellpadding="1" width="100%" border="0"><tbody>
            <TR><TD>Department:</TD><TD><asp:DropDownList id="ddlDepartment" runat="server" Width="90%" CssClass="dropdown" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="false">
             </asp:DropDownList></TD><TD>Sub-Department:</TD><TD><asp:DropDownList id="ddlSubdepartment" runat="server" Width="90%" CssClass="dropdown"  AutoPostBack="false">
             ...
             </asp:DropDownList></TD></TR><TR><TD width="15%"></TD><TD width="35%"></TD><TD width="15%"></TD><TD width="35%"></TD></TR></tbody>
        </table>
   </asp:Panel>
    ...
    <fieldset id="Fieldset1" style="display: block; font-size: 10px;">
        ...
        <legend style="color: Blue;">Note</legend>
        <span class="style2"><asp:CheckBox ID="chkAll" onclick="javascript:chkallchanged(this);" runat="server" Text="All"></asp:CheckBox></span>
        <span class="style2"><asp:CheckBox ID="lnkspecmen" ClientIDMode="Static" runat="server" Text="Specimen Collection"></asp:CheckBox></span>=
        SCOL , <span class="style2"><asp:CheckBox ID="lnkwlist" ClientIDMode="Static" runat="server"  Text="Work List"></asp:CheckBox></span>= WLIST ,
        <span class="style2"><asp:CheckBox ID="lnkREntry" ClientIDMode="Static" runat="server" Text="Result Entry"></asp:CheckBox></span>
        =RENT ,<span class="style2"><asp:CheckBox ID="lnkRVerif" ClientIDMode="Static" runat="server"  Text="Result Verification" ></asp:CheckBox></span>= VERF ,
        <span class="style2"><asp:CheckBox ID="lnkReady" ClientIDMode="Static" Checked="true" runat="server"  Text="Result Ready" ></asp:CheckBox></span> = RDY ,
        <span class="style2"><asp:CheckBox ID="lnkRefund" ClientIDMode="Static" runat="server"  Text="Refuund/Discount" ></asp:CheckBox></span>=REF
        , <span class="style2"><asp:CheckBox ID="lnkArchived" ClientIDMode="Static" runat="server"  Text="Archived" ></asp:CheckBox></span> = ARV
    </fieldset>
    <div>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="Gvonload" runat="server" AutoGenerateColumns="False" Width="100%"
                                DataKeyNames="prid,prno,labid,ProcessID,BranchID,Panel,payment_mode,balance,bookingid,bookingdid,panelid,cashpanel" AllowSorting="True" CssClass="listing"
                                      ...
                                      <asp:TemplateField HeaderText="Visit No" SortExpression="labid">
                                        <ItemTemplate>
                                            ...
                                            <a onmouseover="javascript:switchover12('div<%# Eval("prid") %>');" onmouseout="javascript:switchover12('div<%# Eval("labid") %>');">
                                                <asp:Label ID="lbl_labid" Text='<%# Eval("labid") %>' runat="server"></asp:Label></a>
                                                 <br />
                                                                    <asp:Label ID="lblReferenceNo" Text='<%# Eval("ReferenceNo") %>' Font-Size="X-Small" runat="server"></asp:Label>
                                                                    
                                                <div id="div<%# Eval("labid") %>" style="display: none;">
                                                    <fieldset style="background-color: WHITE; border-style: ridge; padding: 0;">
                                                        <table style="background-color: WHITE; padding: 0; font-size: 8px;" width="80px">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lbl12" Font-Bold="true" runat="server" Font-Size="10px" ForeColor="Blue" Text='<%# Eval("adm_ref") %>'></asp:Label>
                                                                   </td>
                       ...
                       <HeaderStyle HorizontalAlign="Left" />
                            ...
                            SortExpression="dob" />--%>
                                        ...
                                        <ItemTemplate >
                                            <asp:Label ID="lblstatus" Text='<%# Eval("Status")%>' runat="server" ForeColor="Green"
                                                class="label" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"></asp:Label>
                                                 <asp:HyperLink ID="hyperRefund" runat="server" Visible="false">
                                                <asp:Image ID="Img_refund"  Width="14px" ToolTip="Refund Slip" 
                                                    ImageUrl="../img/refund.png" runat="server" />
                                            </asp:HyperLink>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="Branch">
                                        <ItemTemplate>
                                            <asp:Label ID="lblbranch" Text='<%# Eval("Branches")%>' runat="server" class="label"
                                                Font-Bold="False" Font-Names="Arial" Font-Size="10px"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        />
                                            --%>
                                            <asp:ImageButton ID="imgEmail" Width="16px" runat="server" OnClick="imgbtnEmail_Click" OnClientClick="return confirm('Generating pdf will take some time. Are you sure you want to Email the Report?');" ImageUrl="~/img/notification/mail.png" ToolTip="Email pdf" />
                                            <asp:HyperLink style="display:none;" ID="Hyper_email" runat="server">
                                                ...
                                                ImageUrl="headerfooter/cpdf.png" runat="server" />
                                                 <asp:HyperLink  ID="Hyper_lab"  runat="server">
            <asp:Image ID="Image1" ToolTip="Lab Copy" Visible="true" ImageUrl="headerfooter/pdf.png" runat="server" />
        </asp:HyperLink></ItemTemplate><ItemStyle Width="8%" />
                                    </asp:TemplateField>
                                ...
                                <FooterStyle BackColor="#6a9968" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle HorizontalAlign="Left" BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                <PagerStyle BackColor="#6a9968" ForeColor="White" HorizontalAlign="Center" />
...
<%--      <asp:UpdateProgress ID="loadingBar" runat="server">
    <ProgressTemplate>
        <table id="tb2" visible="false" width="100%" runat="server">
        <tr>
            <td align="center">
                <asp:Image ID="Img_bar" Visible="false" Width="300" style="z-index:999999; position:absolute; margin:auto; margin-left:-60px;" Height="160" runat="server" ImageUrl="~/img/wait.gif" />
                   <div style="position: fixed; top: 0px; bottom: 0px; left: 0px; right: 0px; overflow: hidden; padding: 0; margin: 0; background-color: #F0F0F0; filter: alpha(opacity=60); opacity: 0.6; z-index: 100000;"></div>
            </td>
        </tr>
    </table>
    </ProgressTemplate>rdIndoor
  </asp:UpdateProgress>
--%>
        ...
        <asp:UpdatePanel ID="up_war" runat="server">
            <ContentTemplate>
                <table width="100%" id="tb3" runat="server">
                    <tr>
                        <td>
                            <asp:GridView Visible="false" ID="gvPatients" runat="server" AutoGenerateColumns="False" Width="100%"
                                GridLines="Horizontal" CellPadding="0" DataKeyNames="prid,prno,labid,ProcessID,BranchID,Panel,payment_mode,balance,bookingid,bookingdid,panelid,cashpanel"
                                    ...
                                    <%--<asp:TemplateField HeaderText="Visit no" SortExpression="labid">
                                       ...
                                       <asp:TemplateField HeaderText="Visit No" SortExpression="labid">
                                        <ItemTemplate>
                                            ...
                                            <a onmouseover="javascript:switchover12('div<%# Eval("PrID") %>');" onmouseout="javascript:switchover12('div<%# Eval("labid") %>');">
                                                <asp:Label ID="lbl_labid" Text='<%# Eval("labid") %>' runat="server"></asp:Label></a><br /><asp:Label ID="Label1" Text='<%# Eval("ReferenceNo") %>' Font-Size="X-Small" runat="server"></asp:Label><div id="div<%# Eval("labid") %>" style="display: none;">
                                                    <fieldset style="background-color: WHITE; border-style: ridge; padding: 0;">
                                                        <table style="background-color: WHITE; padding: 0; font-size: 8px;" width="80px">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lbl12" Font-Bold="true" runat="server" Font-Size="10px" ForeColor="Blue" Text='<%# Eval("adm_ref ") %>'></asp:Label><br /><asp:Label ID="lblReferenceNo" Text='<%# Eval("ReferenceNo") %>' runat="server"></asp:Label></td></tr></table></fieldset> </div></ItemTemplate><ItemStyle ForeColor="Red" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="Hyper_Receipt" runat="server">
...
<%--                                            <a onmouseover="javascript:switchover('div<%# Eval("labid") %>');" onmouseout="javascript:switchover('div<%# Eval("Patient_Name") %>');">
--%>                                                <asp:Label ID="lbl_action" Text='<%# Eval("Patient_Name") %>' ForeColor="Black" runat="server"></asp:Label><%-- </a>--%><div id="div<%# Eval("Patient_Name") %>" style="display: block;">
                       ...
                       <HeaderStyle HorizontalAlign="Left" />
                            ...
                            SortExpression="dob" />--%>
                                    ...
                                    <asp:TemplateField HeaderText="Status"   SortExpression="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblstatus" Text='<%# Eval("Status")%>' runat="server" ForeColor="Green"
                                                class="label" Font-Bold="False" Font-Names="Arial" Font-Size="8pt"></asp:Label><asp:HyperLink ID="hyperRefund" runat="server" Visible="false"> 
                                        <asp:Image ID="Img_refund"  Width="14px" ToolTip="Refund Slip" 
                                                    ImageUrl="../img/refund.png" runat="server" />
                                            </asp:HyperLink></ItemTemplate><HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="5%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Branch">
                                        <ItemTemplate>
                                            <asp:Label ID="lblbranch" Text='<%# Eval("Branches")%>' runat="server" class="label"
                                                Font-Bold="False" Font-Names="Arial" Font-Size="10px"></asp:Label></ItemTemplate><HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Width="6%" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="StatusDate" HeaderText="Booked" SortExpression="StatusDate"
                                        ItemStyle-Width="8%" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        />
                                            --%>
                                            <asp:ImageButton ID="imgEmail" runat="server" ImageUrl="~/img/notification/mail.png" Width="16px" ToolTip="Send Pdf Report" 
                                            OnClientClick="return confirm('Genearating pdf takes some time. Are You sure you want to Email pdf copy?');" OnClick="imgbtnEmailsearch_Click" />
                                             <asp:HyperLink style="display:none;" ID="Hyper_email" runat="server">
                                                ...
                                                <asp:Image ID="cImg_Email" Width="16px" ToolTip="Email cannot be sent Report is not Ready" Visible="false" ImageUrl="~/img/notification/index.jpg"
                                                    runat="server" />
