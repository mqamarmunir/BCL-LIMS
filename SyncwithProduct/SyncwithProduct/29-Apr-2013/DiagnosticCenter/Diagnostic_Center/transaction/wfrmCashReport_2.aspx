<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wfrmCashReport_2.aspx.cs" Inherits="transaction_wfrmCashReport" %>
...
<body>
  ...
  <%--<asp:Label ID="LB_Ext" Font-Size="9px" Font-Bold="true" runat="server" Text="Ext:" /> <asp:Label ID="Lb_Extension" Font-Size="9px" runat="server" Text=""></asp:Label>--%>
  </p> 
   </td>
   <td style="width:15%;">
                ...
                <ItemTemplate>
                      ...
                      <tr>
                        ...
                        <td align="right">
                                 <table cellpadding="2" cellspacing="2">
                                  <tr>
                                        <td>
                                            <asp:Label ID="Lb_txRegDate" runat="server" Font-Bold="true" Text="Booked At:"></asp:Label>
                                        </td>
                                        <td>
                      ...
                      <table>
                            <tr>
                                ...
                                <%--Visit : &nbsp;<asp:Label ID="lb_urlpath" runat="server" Font-Size="9px" Text="http://www.sindlab.com.pk"></asp:Label>--%>
                                <asp:Label ID="lb_instructions" Font-Size="10px" Font-Bold="false" Text="Login: " runat="server" ></asp:Label>
                                &nbsp;<asp:Label ID="Label7" runat="server" Font-Size="10px" Text="www.sindlab.com.pk"></asp:Label>
                                &nbsp;&nbsp;
                                 <asp:Label ID="Lb_txPRNoGv" runat="server" Font-Size="10px" Font-Bold="false" Text="Username:"></asp:Label>
                                        <asp:Label ID="Lb_PRNOGv" runat="server" Font-Size="10px" Text='<%# Eval("prno")  %>'></asp:Label> 
                                        &nbsp;&nbsp;
                                         <asp:Label ID="Label4" runat="server" Font-Size="10px" Font-Bold="false" Text="Password:"></asp:Label>
...
<%--<fieldset style="border-radius:10px;"> --%>  
        ...
        <wc:ReportGridView BorderColor="#DDDDDD"  GridLines="Horizontal" Font-Size="11px" 
            style="font-family:Tahoma;border:1px solid #EEEEEE;" AllowPrintPaging="true"  ID="Gv_PatientReceipt" runat="server" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="speedkey" HeaderText="Test Code" Visible="false" />
            <asp:BoundField DataField="deliverydatetime" HeaderText="Reporting Date" />
            <asp:BoundField DataField="charges" Visible="false" />
        ...
        <table width="100%" style="margin-bottom:-10px;">
            <tr>
            <td width="70%" style="font-size:x-small; font-weight:bold" align="left">Note: HardCopy of Report can be obtained from any of the branch</th>
                <td align="right">
                        <asp:Label ID="Lb_SpecimenInternal" runat="server" Font-Size="10px"></asp:Label>
                        &nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Lb_Entered" Font-Size="11px" Font-Bold="true" Text="Entered By :" runat="server" ></asp:Label>
        ...
        <Columns>
           ...
           <tr>
                ...
                <td align="right">
                 ...
                 <asp:Label  Font-Bold="true" Visible="false" ID="Lb_disc" runat="server" Text="Discount Amount: Rs."></asp:Label>
                 <asp:Label  ID="lb_discValue" Visible="false"  runat="server"  Text='<%# Eval("discount_amt") %>'></asp:Label>
               </td>
                <td></td>
                <td></td>
            </tr>
        ...
        <table width="100%" border="0" style="font-size:10px; font-family:Tahoma;">
                <tr>
                    <td style="width:60%;" valign="top">
                        <fieldset id="fieldleft" runat="server" style="border-radius:10px;">
                            <%-- <tr>
                                                 <td>
                                                    <asp:Label ID="Lb_txAgeSex" runat="server" Font-Bold="true" Text="Age / Gender:"></asp:Label>
                                                </td>
