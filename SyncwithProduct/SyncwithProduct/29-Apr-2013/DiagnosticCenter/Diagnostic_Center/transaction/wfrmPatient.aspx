<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/transaction/wfrmPatient.aspx.cs" Inherits="PatientReg" Title="Patient Registration" %>
...
<asp:AsyncPostBackTrigger ControlID="lbtnSaveDependent" EventName="Click"></asp:AsyncPostBackTrigger>
        ...
        <tr>
            ...
            <td align="right" colspan="4">
                &nbsp; &nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="lbtnPatientTrack" runat="server" OnClick="lbtnPatientTrack_Click" Font-Size="10px">Patient Investigation Tracking</asp:LinkButton></td>
        </tr>
        <tr>
            <td colspan="8">
           <asp:UpdatePanel id="up_empInfo" runat="server"><ContentTemplate>
<asp:Panel id="pnl_panelInfo" runat="server" Font-Bold="True" Width="99%" GroupingText="Employee Info"><TABLE id="tb_PanelInfo" class="label" cellSpacing=1 cellPadding=1 width="100%" border=0><TBODY><TR><TD>PR #:</TD><TD><asp:Label id="lblPR_Parent_Panel" runat="server" ForeColor="darkblue" Text=""></asp:Label></TD><TD>Name:</TD><TD><asp:Label id="lblParent_Panel" runat="server" ForeColor="darkblue" Text=""></asp:Label></TD><TD>Service #:</TD><TD><asp:Label id="lblServ_Panel" runat="server" ForeColor="darkblue" Text=""></asp:Label> <asp:Label id="lblMarit_Panel" runat="server" Visible="False"></asp:Label></TD><TD>Panel:</TD><TD><asp:Label id="lblCmp_panel" runat="server" ForeColor="DarkBlue"></asp:Label></TD></TR><TR><TD style="HEIGHT: 18px" width="5%"></TD><TD style="HEIGHT: 18px" width="15%"></TD><TD style="HEIGHT: 18px" width="5%"></TD><TD style="HEIGHT: 18px" width="20%"></TD><TD style="HEIGHT: 18px" width="8%"></TD><TD style="HEIGHT: 18px" width="20%"></TD><TD style="HEIGHT: 18px" width="5%"></TD><TD style="HEIGHT: 18px" width="22%"></TD></TR></TBODY></TABLE></asp:Panel> 
</ContentTemplate>
               <triggers>
        ...
        <tr>
            <td colspan="8">
             ...
             <asp:UpdatePanel ID = "up_pateintInfo" runat="server">
                <ContentTemplate>
<asp:Panel id="pnlPatient" runat="server" Font-Bold="True" Width="99%" GroupingText="Patient Info"><TABLE id="tb_patient" class="label" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD>PR No:</TD><TD><asp:TextBox id="txtPRnO" runat="server" ToolTip="Please enter PR #" Width="65%" CssClass="field"></asp:TextBox> <asp:ImageButton id="imgPRno" onclick="imgPRno_Click" runat="server" ImageUrl="~/images/btn_Blank.GIF"></asp:ImageButton></TD><TD></TD><TD align=left colSpan=3><asp:RadioButton id="rdbCash" runat="server" Font-Bold="True" ForeColor="Teal" __designer:wfdid="w31" Text="Cash" OnCheckedChanged="rdbCash_CheckedChanged" AutoPostBack="True" GroupName="CHK"></asp:RadioButton> <asp:RadioButton id="rdbPanel" runat="server" Font-Bold="True" ForeColor="Teal" __designer:wfdid="w32" Text="Panel" OnCheckedChanged="rdbPanel_CheckedChanged" AutoPostBack="True" GroupName="CHK"></asp:RadioButton><asp:RadioButton id="rdbPnl_Cash" runat="server" Font-Bold="True" ForeColor="Teal" __designer:wfdid="w33" Text="Panel-Cash" OnCheckedChanged="rdbPnl_Cash_CheckedChanged" AutoPostBack="True" GroupName="CHK"></asp:RadioButton><asp:Label id="lblRela_hd" runat="server" __designer:wfdid="w34" Text="Relation:"></asp:Label>&nbsp;</TD><TD><asp:DropDownList id="ddlRelation" runat="server" Width="100%" CssClass="dropdown" AutoPostBack="true" OnSelectedIndexChanged="ddlRelation_SelectedIndexChanged"><asp:ListItem Value="-1">Select</asp:ListItem>
...
</asp:DropDownList> <asp:Label id="lblName_Panel" runat="server" ForeColor="DarkBlue"></asp:Label></TD><TD>&nbsp;</TD></TR><TR><TD colSpan=8><asp:Panel id="pnlPanel" runat="server" Width="99%"><TABLE id="tb_panel" class="label" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD>Panel Company:</TD><TD><asp:DropDownList id="ddlPanel" runat="server" ToolTip="Please select panel company" Width="100%" CssClass="dropdownMan" AutoPostBack="false" OnSelectedIndexChanged="ddlPanel_SelectedIndexChanged">
                                                </asp:DropDownList></TD><TD align=center>
        Employee No:</TD><TD><asp:TextBox id="txtSErviceNO" runat="server" ToolTip="Please enter patient service number" Width="85%" CssClass="mandatoryField" MaxLength="10"></asp:TextBox></TD><TD align=left>
    Referecnce:</TD><TD>
        <asp:TextBox ID="txtReferenceNo" runat="server" __designer:wfdid="w1" 
            CssClass="field" MaxLength="25" Width="90%"></asp:TextBox>
...
</asp:DropDownList>&nbsp; <asp:CheckBox id="chkTitleENB" runat="server" __designer:wfdid="w1" Text="Skip Title" OnCheckedChanged="chkTitleENB_CheckedChanged" AutoPostBack="True" Checked="True"></asp:CheckBox></TD><TD align=right>Name:&nbsp; </TD><TD colSpan=3><asp:TextBox id="txtName" tabIndex=2 onkeyup="this.value=TitleCase(this);" runat="server" ToolTip="Please enter patient name" Width="97%" CssClass="mandatoryField" MaxLength="95"></asp:TextBox></TD><TD>Gender:</TD><TD><asp:RadioButton id="rdbMale" tabIndex=3 runat="server" Text="Male" GroupName="Gender"></asp:RadioButton> <asp:RadioButton id="rdbFemle" tabIndex=4 runat="server" Text="Female" GroupName="Gender"></asp:RadioButton></TD></TR><TR><TD>DOB:</TD><TD><asp:TextBox id="txtDOB" tabIndex=5 runat="server" ToolTip="Enter date of birth here or age in next box" Width="40%" CssClass="mandatoryField"></asp:TextBox></TD><TD align=right>Age:&nbsp; </TD><TD><asp:TextBox id="txtAge" tabIndex=6 runat="server" ToolTip="Enter age in years " Width="30%" CssClass="mandatoryField" MaxLength="3"></asp:TextBox> <asp:DropDownList id="ddlAge_Opt" runat="server" Width="60%" __designer:wfdid="w1"><asp:ListItem Value="Y">Year(s)</asp:ListItem>
<asp:ListItem Value="M">Month(s)</asp:ListItem>
<asp:ListItem Value="D">Day(s)</asp:ListItem>
</asp:DropDownList></TD><TD align=right>Cell No:&nbsp; </TD><TD><asp:TextBox id="txtCellNo" tabIndex=7 runat="server" ToolTip="Please enter patient cell number" Width="94%" CssClass="field" MaxLength="20"></asp:TextBox></TD><TD>Marital Status:</TD><TD><asp:DropDownList id="ddlMarital" tabIndex=8 runat="server" ToolTip="Please select Patient Marital Status" Width="60%" CssClass="dropdownMan">
                                    <asp:ListItem Value="-1">Select</asp:ListItem>
                                    <asp:ListItem Value="S">Single</asp:ListItem>
                                    <asp:ListItem Value="M">Married</asp:ListItem>
                                </asp:DropDownList></TD></TR><TR><TD>Phone No:</TD><TD><asp:TextBox id="txtHPHone" tabIndex=9 runat="server" ToolTip="Please enter patient phone number" Width="97%" CssClass="field" MaxLength="20"></asp:TextBox></TD><TD align=right>Fax:&nbsp; </TD><TD><asp:TextBox id="txtFax" tabIndex=10 runat="server" ToolTip="Please enter patient fax number" Width="95%" CssClass="field" MaxLength="20"></asp:TextBox></TD><TD align=right>CNIC:&nbsp; </TD><TD><asp:TextBox id="txtCNIC" tabIndex=11 runat="server" ToolTip="Please enter patient CNIC" CssClass="field"></asp:TextBox></TD><TD>
        &nbsp;</TD><TD>&nbsp;</TD></TR><TR><TD>Email:</TD><TD><asp:TextBox id="txtEmail" tabIndex=12 runat="server" ToolTip="Please enter patient email address" Width="95%" CssClass="field"></asp:TextBox></TD><TD align=right>Address:</TD><TD colSpan=3><asp:TextBox id="txtAddress" tabIndex=13 runat="server" ToolTip="Please enter patient address" Width="85%" CssClass="field" Height="39px" TextMode="MultiLine"></asp:TextBox></TD><TD>Remarks: &nbsp; <asp:LinkButton id="lbtnAdd_Rmk" onclick="lbtnAdd_Rmk_Click" runat="server" __designer:wfdid="w1">Add</asp:LinkButton></TD><TD><asp:TextBox id="txtRemark" runat="server" Width="78%" CssClass="field" __designer:wfdid="w2" TextMode="MultiLine"></asp:TextBox><asp:ImageButton id="imgOpn_Rmk" onclick="imgOpn_Rmk_Click" runat="server" ImageUrl="~/images/expandw.jpg" __designer:wfdid="w3"></asp:ImageButton></TD></TR><TR><TD></TD><TD></TD><TD align=right></TD><TD colSpan=3></TD><TD></TD><TD><asp:ListBox id="lbTemplate" runat="server" Visible="False" Width="97%" __designer:wfdid="w4" AutoPostBack="True" OnSelectedIndexChanged="lbTemplate_SelectedIndexChanged">
...
<asp:Panel id="pnlGen" runat="server" Font-Bold="True" Width="99%" GroupingText="Referral Info" Height="50px" __designer:errorcontrol="'Enter here if not available in previous list' could not be set on property 'WatermarkText'."><TABLE id="tb_gen" class="label" cellSpacing=1 cellPadding=1 width="100%" border=0><TBODY><TR><TD>
...
<asp:AsyncPostBackTrigger ControlID="rdbPanel" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>
        ...
        <tr>
            <td colspan="8">
                <asp:GridView ID="gvPatient" runat="server" CssClass="datagrid" AutoGenerateColumns="False" Width="99%" DataKeyNames="prid,title,name,cnic,address,panelid,serviceno,fax,relation,panelpatient,f_parent,email,dob" OnRowCommand="gvPatient_RowCommand">
