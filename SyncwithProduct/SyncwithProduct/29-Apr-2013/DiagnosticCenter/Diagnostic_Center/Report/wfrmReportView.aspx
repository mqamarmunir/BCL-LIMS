          ...
          <tr>
              <td colspan="4">
                  <asp:GridView ID="gvWorkList" runat="server"  AutoGenerateColumns="False"  
                      CssClass="datagrid" Width="100%" DataKeyNames="testid"
                      onselectedindexchanged="gvWorkList_SelectedIndexChanged" OnRowDataBound="gvWorkList_RowDataBound">
                      <RowStyle CssClass="gridItem" />
                      <Columns>
                          ...
                          <tr><td colspan="4">
                           <table width="100%">
                           <tr><td>
                          <asp:GridView ID="gv_test_attributes" runat="server" AutoGenerateColumns="false" Width="100%">
                          <Columns>
                          <asp:BoundField DataField="Attribute_Name" HeaderText="Attributes" HeaderStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#cdc9c9" />
                          </Columns>
                          </asp:GridView>
                          </td></tr>
                          </table>
