...
public partial class test_turnover : System.Web.UI.Page
{
    ...
    protected void imgReport_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ddlDepartment.SelectedIndex > 0)
            _SelectionFormula += " and {command.departmentid}="+ddlDepartment.SelectedItem.Value.ToString();
        if (ddlSubDept.SelectedIndex > 0)
            _SelectionFormula += " and {command.subdepartmentid}=" + ddlSubDept.SelectedItem.Value.ToString();
        if (ddlGroup.SelectedIndex > 0)
            _SelectionFormula += " and {command.groupid}=" + ddlGroup.SelectedItem.Value.ToString();
        ...
        try
        {
            ...
            string strRUrl = Server.MapPath(@"../Report/test_turnovr.rpt");
            ...
            string szFileName = Server.MapPath(@"pdf/test_turnovr.pdf");
            ...
            ScriptManager.RegisterStartupScript(this, typeof(Page), "Test Ordering Summary", @"<script>window.open('pdf/test_turnovr.pdf');</script>", false);
    ...
    private void Fill_SubDept()
    {
        ...
        SComponents com = new SComponents();
        if (ddlDepartment.SelectedIndex > 0)
            mn.DepartmentID = this.ddlDepartment.SelectedItem.Value.ToString();
    ...
    private void Fill_Test()
    {
        ...
        SComponents com = new SComponents();
        if (ddlSubDept.SelectedIndex > 0)
            mn.SubDepartmentID = this.ddlSubDept.SelectedItem.Value.ToString();
