<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfrmBranchPanels.aspx.cs" Inherits="Parameter_wfrmBranchPanels" %>
...
<tr>
<td colspan="7" align="center"> <font size="4"><strong>Branch Panel Registration</strong></font>
...
<ContentTemplate>
  ...
  <div runat="server" visible="false" id="divpanels">
    <fieldset>
    <legend>Organization Panels</legend>
        <table id="tblpanels" width="99%" class="label">
            <tr>
            <td colspan="2">Filter:<input type="text" class="field" id="Filtertest" onkeyup="filtertext(this,'<%=gvPanels.ClientID %>',1)" /></td>
            ...
            <td colspan="4">
             ...
             <asp:GridView ID="gvPanels" Width="99%" runat="server" CssClass="label" AutoGenerateColumns="false"
              DataKeyNames="PanelId">
             ...
             <asp:BoundField HeaderText="Panel Name" DataField="Name" />
    ...
    <legend>Branch Panels</legend>
        <table id="tblSelected" width="99%" class="label">
            ...
            <td colspan="4">
             ...
             OnRowDeleting="gvSelected_RowDeletingClick" DataKeyNames="branchpanelid,panelid,branchid">
             <HeaderStyle CssClass="gridheader" HorizontalAlign="Left" />
             <RowStyle CssClass="gridItem" />
             <AlternatingRowStyle CssClass="gridAlternate" />
             <Columns>
