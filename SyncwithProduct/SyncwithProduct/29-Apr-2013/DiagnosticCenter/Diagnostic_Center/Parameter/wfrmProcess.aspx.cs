...
public partial class wprocess : System.Web.UI.Page
{
    ...
    private void FillGV()
    {
        clsBLProcess pr = new clsBLProcess();
    ...
    private void Insert()
    {
        ...
        pr.Name = this.txtProcess.Text.Trim();
    ...
    private void Update()
    {
        ...
        pr.ProcessID = this.lblID.Text.Trim();
        pr.Name = this.txtProcess.Text.Trim();
        pr.Acronym = this.txtAcronym.Text.Trim();
        pr.Active = this.chkActive.Checked ? "Y" : "N";
    ...
    private bool Validate_Form()
    {
        ...
        if (txtProcess.Text.Trim().Equals(""))
        {
            lblError.Text = "Please enter process name.(empty is not allowed)";
            return false;
        }
    ...
    protected void gvProcess_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("Select"))
        {
            ...
            lblID.Text = gvProcess.DataKeys[index].Value.ToString();

            txtProcess.Text = gvProcess.Rows[index].Cells[1].Text.Trim().Replace("&nbsp;", "");
            txtAcronym.Text = gvProcess.Rows[index].Cells[2].Text.Trim().Replace("&nbsp;", "");

            chkActive.Checked = ((CheckBox)(gvProcess.Rows[index].Cells[3].FindControl("chkGVActive"))).Checked;
            lblStatus.Text = "u";
