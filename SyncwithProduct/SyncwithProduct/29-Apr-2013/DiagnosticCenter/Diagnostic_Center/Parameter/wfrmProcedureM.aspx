<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="~/Parameter/wfrmProcedureM.aspx.cs" Inherits="_Default" Title="Procedure Registration" %>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                Name:</td>
             <td colspan="3">
                 <asp:TextBox ID="txtProcedure" runat="server" CssClass="mandatoryField" Width="99%"></asp:TextBox></td>
            <td align="right">
                Acronym:</td>
            <td>
         ...
         <tr>
            ...
            <td></td>
            <td colspan="4">
                <asp:GridView ID="gvProcedure" runat="server" AutoGenerateColumns="False" CssClass="datagrid" DataKeyNames="procedureid" OnRowCommand="gvProcedure_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="name" HeaderText="Procedure">
