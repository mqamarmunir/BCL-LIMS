  ...
  <asp:Label ID="Lb_Extension" Font-Size="9px" runat="server" Text=""></asp:Label>
   ...
   <asp:Label ID="Lb_dateAll" Visible="false" runat="server" Text=""></asp:Label>
      ...
      <asp:GridView Width="100%" Font-Size="12px" style="font-family:Tahoma; color:Black;" 
        ...
        <asp:GridView PageSize="1" DataKeyNames="bookingdid,testid,prid,automatedtext"   AllowPaging="true"  ID="Gv_GroupTest"  GridLines="None" Font-Size="12px" 
       ...
       <asp:Label ID="Lb_PrintCount" style="float:right; font-size:10px;" runat="server" Font-Bold="true" Text=""></asp:Label>
...
<%-- <tr>
        ...
        <table class="style2" width="100%" style="font-size: 6px">
            <tr>
                ...
                <td width="12%" valign="top">
                    <asp:Label ID="Label27" runat="server" Font-Bold="true" Text="Dr.Muhammad Usman Ansari"></asp:Label>
                </td>
                <td width="12%" valign="top">
